    ...
    <div className="">
      ...
      >
        ...
        <div className="bg-hero-pattern w-full bg-top bg-cover bg-no-repeat h-screen">
          <div className="px-5 md:px-10 lg:px-12 lgg:px-16 2xl:px-20 pt-20 xl:pt-28 h-full flex flex-col justify-center pb-4">
            <div className="text-white max-w-[1150px] mx-auto text-center flex flex-col items-center flex-grow justify-center">
              ...
              <div className="flex flex-col items-center mt-4 min-[1360px]:mt-16 mb-4 2xl:my-8">
                ...
                <div className="flex items-center gap-6 min-[1681px]:my-8 max-lg:flex-wrap max-lg:justify-center">
                  <div className="lgg:hidden  max-lgg:basis-full max-lgg:-mb-16">
                    <RadialBarChart />
                  </div>
                  <div className="flex flex-col items-center max-sm:w-full">
                    ...
                    <div className="hidden lgg:flex 2xl:hidden items-center gap-2 mt-3">
                      <IconUpArrow />
                      <p className="font-24">
                        22 087 474.56{" "}
              ...
              <div className="flex lgg:hidden 2xl:flex items-center flex-col max-sm:mt-0 max-lg:mt-10">
            ...
            <div className="flex justify-between md:mt-6 lg:mt-0 2xl:mt-14 text-white items-center max-sm:flex-col">
        ...
        {/* Third Slide */}
        <div className="flex items-center pb-4 bg-hero-pattern-three w-full h-screen xl:bg-contain bg-center bg-no-repeat">
          <div className="text-white max-w-[1150px] mx-auto text-center flex flex-col items-center px-5 md:px-10 lg:px-12 lgg:px-16 2xl:px-20 pt-20 xl:pt-28 h-full justify-center">
