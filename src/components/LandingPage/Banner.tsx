...
const Banner = () => {
  ...
  return (
      ...
      <div className="">
        ...
        >
          {/* Carousel items */}
          <div className="flex items-center p-1 bg-hero-pattern w-full h-[700px] 2xl:h-[1130px] bg-top bg-cover bg-no-repeat">
            <div className="flex items-center px-20 pt-40">
              <div className="text-white basis-3/5">
                ...
                <p className="pb-4 pt-6">
                  Experience advanced AI & ML powered investing like never
                  before with our fully automated AI-powered robo advisor
                </p>
                <p>
          ...
          <div className="pb-4 bg-hero-pattern w-full h-[700px] 2xl:h-[1130px] bg-top bg-cover bg-no-repeat">
          ...
          <div className="flex items-center pb-4 bg-hero-pattern-three w-full h-[700px] 2xl:h-[1130px] bg-top bg-cover bg-no-repeat">
            <div className="text-white max-w-[1150px] mx-auto text-center flex flex-col items-center px-20 pt-40">
